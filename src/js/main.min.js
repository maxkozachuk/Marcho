...
function getTimeRemaining(e){const o=Date.parse(e)-Date.parse(new Date),t=Math.floor(o/1e3%60),n=Math.floor(o/1e3/60%60),r=Math.floor(o/36e5%24);return{total:o,days:Math.floor(o/864e5),hours:r,minutes:n,seconds:t}}function initializeClock(e,o){const t=document.querySelector(e),n=t.querySelector(".promo__days"),r=t.querySelector(".promo__hours"),a=t.querySelector(".promo__minutes"),i=t.querySelector(".promo__seconds");function c(){const e=getTimeRemaining(o);n.innerHTML=e.days,r.innerHTML=("0"+e.hours).slice(-2),a.innerHTML=("0"+e.minutes).slice(-2),i.innerHTML=("0"+e.seconds).slice(-2),e.total<=0&&clearInterval(l)}c();const l=setInterval(c,1e3)}$((function(){$(".top-slider__inner").slick({arrows:!1,dots:!0,fade:!0,autoplay:!0,autoplaySpeed:2e3}),$(".product-item__rating").rateYo({starWidth:"18px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0})})),Fancybox.bind("[data-fancybox]",{});const deadline=new Date(Date.parse(new Date)+1296e6);initializeClock(".promo__timer",deadline);