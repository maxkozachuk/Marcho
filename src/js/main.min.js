...
function getTimeRemaining(e){const t=Date.parse(e)-Date.parse(new Date),i=Math.floor(t/1e3%60),n=Math.floor(t/1e3/60%60),o=Math.floor(t/36e5%24);return{total:t,days:Math.floor(t/864e5),hours:o,minutes:n,seconds:i}}function initializeClock(e,t){const i=document.querySelector(e),n=i.querySelector(".promo__days"),o=i.querySelector(".promo__hours"),r=i.querySelector(".promo__minutes"),c=i.querySelector(".promo__seconds");function a(){const e=getTimeRemaining(t);n.innerHTML=e.days,o.innerHTML=("0"+e.hours).slice(-2),r.innerHTML=("0"+e.minutes).slice(-2),c.innerHTML=("0"+e.seconds).slice(-2),e.total<=0&&clearInterval(l)}a();const l=setInterval(a,1e3)}$((function(){$(".filter-content__btn").on("click",(function(){$(".filter-content__btn").removeClass("filter-content__btn--active"),$(this).addClass("filter-content__btn--active")})),$(".filter-content__btn--list").on("click",(function(){$(".product-item").addClass("product-item--list"),$(".shop__items").removeClass("shop__items--grid")})),$(".filter-content__btn--grid").on("click",(function(){$(".product-item").removeClass("product-item--list"),$(".shop__items").addClass("shop__items--grid")})),$(".pagination__link").on("click",(function(){$(".pagination__link").removeClass("pagination__link--active"),$(this).addClass("pagination__link--active")})),$(".filter-content__select").styler(),$(".top-slider__inner").slick({arrows:!1,dots:!0,fade:!0,autoplay:!0,autoplaySpeed:2e3}),$(".product-item__rating").rateYo({starWidth:"18px",normalFill:"#ccccce",ratedFill:"#ffc35b",readOnly:!0}),$(".price-filter__input").ionRangeSlider({type:"double",prefix:"$",hide_min_max:!0,hide_from_to:!0,onStart:function(e){$(".price-filter__price-from").text(e.from),$(".price-filter__price-to").text(e.to)},onChange:function(e){$(".price-filter__price-from").text(e.from),$(".price-filter__price-to").text(e.to)}})})),Fancybox.bind("[data-fancybox]",{});const deadline=new Date(Date.parse(new Date)+1296e6);initializeClock(".promo__timer",deadline);